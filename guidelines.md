...
- Aktuelle Prompt-Version: `v0.4-varied-scope-guard`.
- PromptBuilder enthält Scope-Guard-Regeln: NPCs sind keine allgemeinen Chatbots, beantworten keine themenfremden externen Fragen und führen Off-Topic-Eingaben kurz, abwechslungsreich und im Charakter zurück zum Fall Viktor Stein.
